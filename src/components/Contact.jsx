   ...
   className="section">
    <div className='container lg:grid lg:grid-cols-2 lg:items-stretch'>
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
            <h2 className='headline-2 lg:max-w-[16ch]'> Contact Me</h2>

            <p className='text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] '>I'm currently looking for a job as a frontend developer.
                If you have any opportunities or want to collaborate, feel free to get in touch with me.
                You can contact me through the form below or email me directly.
            </p>
        ...
        <form 
        action="https://getform.io/f/bxowpqla"
        method='POST'
        ...
        >
            ...
            <div className='md:grid md:items-center md:grid-cols-2 md:gap-2'>
                <div className='mb-4'>
                    ...
                    <input type="text" name="name" id="name" autoComplete='name' required placeholder='Pushpakala John' className="text-field" />
                </div>
                ...
                <div className='mb-4'>
                    ...
                    <input type="text" name="email" id="email" autoComplete='email' required placeholder='Pushpakala' className="text-field" />
                </div>
                ...
                <div className="mb-4">
                    ...
                    <textarea name="message" id="message" placeholder = "Hi" required className='text-field resize-y min-h-32 max-h-60'></textarea>
                </div>
